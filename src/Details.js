...
function Details(props) {
	...
	return (
		<div>
			...
			<Overlay visible={showAddPayOverlay} bgClick={() => setShowAddPayOverlay(false)} height={40}>
				...
				<center>
					...
					<br/><br/>
					{
						...
						: <input type='number' pattern="[0-9]*" placeholder={nextPayment.amount.housing} class="editable-label-input"/>
					}
